    ...
    <div class="bg-surface shadow-sm border border-border-main border-t-4 border-t-crimson p-8 w-full">
        ...
        @if (session('status'))
            ...
            <div class="text-center">
                ...
                <div class="space-y-4">
                    <a href="mailto:"
                        class="w-full flex justify-center py-3 px-4 border border-transparent text-sm font-heading font-bold uppercase tracking-wider text-white bg-navy hover:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-navy transition-colors">
                        Open Email App
                    </a>
                ...
                <div class="mt-8">
                    <a href="{{ route('login') }}"
                        class="text-sm font-semibold text-gray-500 hover:text-navy uppercase tracking-wider">
                        &larr; Back to Login
                    </a>
                </div>
            </div>
        @else
            ...
            <form method="POST" action="{{ route('password.email') }}" class="space-y-6">
                ...
                <div>
                    <label for="email"
                        class="block text-sm font-semibold text-navy uppercase tracking-wider mb-2">Institutional
                        Email</label>
                    <input id="email"
                        class="block w-full border-border-main bg-gray-50 focus:bg-white focus:ring-0 focus:border-navy px-4 py-3 text-text-main sm:text-sm"
                ...
                <div class="flex items-center justify-between pt-4">
                    <a href="{{ route('login') }}"
                        class="text-sm font-semibold text-crimson hover:text-navy uppercase tracking-wider transition-colors">
                        Return to Login
                    </a>

                    <button type="submit"
                        class="flex justify-center py-3 px-6 border border-transparent text-sm font-heading font-bold uppercase tracking-wider text-white bg-navy hover:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-navy transition-colors">
                        Send Reset Link
                    </button>
                </div>
            </form>
