            ...
            <div class="lg:col-span-4 space-y-6">
                ...
                <div x-show="isEventCategory" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 -translate-y-2" x-transition:enter-end="opacity-100 translate-y-0" x-cloak class="bg-amber-50 border border-amber-200 p-6 shadow-sm">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="datetime-local" name="event_date" id="event_date" value="{{ old('event_date') }}" class="w-full bg-white border border-amber-300 px-4 py-2.5 text-sm text-gray-900 focus:outline-none focus:border-[#8b1528] focus:ring-0 rounded">
                    </div>
                    ...
                    <div x-data="{ hasRegistration: {{ old('registration_link') ? 'true' : 'false' }} }" class="mb-1">
                        ...
                        <div x-show="hasRegistration" x-transition class="space-y-4 pl-2 border-l-2 border-amber-300">
                            ...
                            <div>
                                ...
                                <input type="url" name="registration_link" id="registration_link" value="{{ old('registration_link') }}" placeholder="https://forms.gle/..." class="w-full bg-white border border-amber-300 px-4 py-2.5 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:border-[#8b1528] focus:ring-0 rounded">
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="registration_deadline" id="registration_deadline" value="{{ old('registration_deadline') }}" class="w-full bg-white border border-amber-300 px-4 py-2.5 text-sm text-gray-900 focus:outline-none focus:border-[#8b1528] focus:ring-0 rounded">
                                <p class="mt-1 text-[10px] text-amber-600">Tombol "Daftar Sekarang" akan otomatis disembunyikan setelah tanggal ini. Kosongkan agar tombol tampil terus.</p>
                            </div>
                        </div>
                    </div>
                </div>
...
function authorArticleFormHandler() {
    return {
        ...
        init() {
            // Detect if 'Events' category is already selected on page load (e.g. old() repopulation)
