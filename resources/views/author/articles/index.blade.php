...
@section('page_tour_id', 'author.articles.index')
...
<div class="max-w-6xl mx-auto space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <a href="{{ route('author.articles.create') }}" data-tour="articles-write-btn" class="px-5 py-2.5 bg-[#8b1528] hover:bg-[#721120] text-white text-xs font-bold uppercase tracking-wider flex items-center gap-2 shadow-sm transition-colors self-start sm:self-auto">
    ...
    <div class="flex items-center gap-2 border-b border-gray-200 pb-px overflow-x-auto text-xs font-semibold uppercase tracking-wider" data-tour="articles-status-tabs">
        @php
    ...
    <!-- Search Controls -->
    <div class="bg-white border border-gray-200 p-4 shadow-sm" data-tour="articles-search-bar">
    ...
    <!-- Articles Table Card -->
    <div class="bg-white border border-gray-200 shadow-sm overflow-hidden relative" data-tour="articles-table">
        @php
            $hasAnyBoosted = false;
        @endphp
