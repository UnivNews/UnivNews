...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="bg-white border border-gray-200 shadow-sm p-6">
        <form method="POST" action="{{ route('author.articles.boost.store', $article) }}" id="boostForm">
            ...
            <div class="mb-6 bg-gray-50 p-4 border border-gray-200" id="calendarPreview" style="display: none;">
            ...
            <div class="flex justify-end gap-3">
                ...
                <button type="submit" id="submitBtn" class="px-5 py-2.5 bg-[#8b1528] hover:bg-[#721120] text-white font-bold text-sm uppercase tracking-wider flex items-center gap-2">
                    Lanjut Pembayaran
                </button>
            </div>
        </form>
